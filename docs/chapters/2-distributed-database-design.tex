...
The system consists of three MySQL database nodes deployed on separate virtual machines. Each node runs independently and communicates with the others through a custom transaction log-based synchronization mechanism. The nodes are configured as follows:
