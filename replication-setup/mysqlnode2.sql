...
ALTER TABLE DimTitle AUTO_INCREMENT = 11923618;
...
SOURCE_PASSWORD="cliveisgay", SOURCE_PORT=3306, SOURCE_AUTO_POSITION=1, GET_SOURCE_PUBLIC_KEY=1 FOR CHANNEL "Node1ToNode2";
